 ...
 *
 * @key: A unique string key associated with a value in the HashTable
 ...
 * @array: An array of size @size containing pointers to the first nodes
 *         of linked lists, used for collision resolution (chaining).
 */
